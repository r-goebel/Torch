...
char* effectList[] = {"fade","cylon","twinkle", "twinkle random", "sparkle", "sparkle random"};//,"ColorWipe","RainbowCycle","TheaterChase","TheaterChaseRainbow","Fire","MeteorRain","Rain","Plasma"};
